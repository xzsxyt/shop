<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"C:\wamp64\www\project1/wstshop/admin\view\ads\edit.html";i:1523179462;s:51:"C:\wamp64\www\project1/wstshop/admin\view\base.html";i:1523179462;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
  ...
  <tr>
      <th width='150'>位置类型<font color='red'>*</font>：</th>
       ...
       <tr>
          ...
          <td>
            <input type="text" id="adURL" class="ipt" maxLength="20" value='<?php echo $data['adURL']; ?>' />
          </td>
       </tr>
       <tr>
...
editInit();
//初始化位置类型
if("<?php echo $data['positionType']; ?>" != '')addPosition("<?php echo $data['positionType']; ?>","<?php echo $data['adPositionId']; ?>");
//时间插件
