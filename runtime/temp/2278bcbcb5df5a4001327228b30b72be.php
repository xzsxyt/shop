<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"C:\wamp64\www\project1/wstshop/home\view\default\error_sys.html";i:1523179466;s:58:"C:\wamp64\www\project1/wstshop/home\view\default\base.html";i:1523179472;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\header.html";i:1523179466;s:64:"C:\wamp64\www\project1/wstshop/home\view\default\header_top.html";i:1523179466;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\footer.html";i:1523179472;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>系统出错了 - <?php echo WSTConf('CONF.shopName'); ?><?php echo WSTConf('CONF.seoShopTitle'); ?></title>
...
<div style="width:100%;height:600px;background:#e1f1f5;">
	<div class="wst-empty empty2">
		<div class="button2">
			<a href="javascript:history.go(-1)" class="wst-empty-btn wst-empty-btn1">返回上一页</a>
		   <a href="<?php echo \think\Request::instance()->root(true); ?>" class="wst-empty-btn wst-empty-btn1">返回首页</a>
		</div>
	</div>
</div>
<div class="wst-container">
	...
	<div style="width:100%;height:auto;">
		<div class="uc-goods-box">
      	<div class="wst-user-head"><span>商品推荐</span></div>
	      	<?php $wstTagGoods =  model("Tags")->listGoods("recom",0,6,0); foreach($wstTagGoods as $key=>$rec){?>
		...
		<div class="uc-goods-box">
      	  <div class="wst-user-head"><span>我的足迹</span></div>
	      	<?php $wstTagGoods =  model("Tags")->listGoods("history",0,6,0); foreach($wstTagGoods as $key=>$his){?>
	      	<div class="rnbh-goods">
