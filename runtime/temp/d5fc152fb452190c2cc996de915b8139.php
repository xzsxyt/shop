<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"C:\wamp64\www\project1/wstshop/home\view\default\box_login.html";i:1523179472;}*/ ?>
	...
	<table class="wst-table">
		...
		<tr class="wst-login-tr">
			<td colspan="2" style="padding-left:43px;">
				<input id="rememberPwd" name="rememberPwd" class="ipt" checked="checked" type="checkbox"/>
				<label>记住密码</label>                                      
				<label><a style="color:#666;line-height:32px;margin-left:10px;" target='_blank' href="<?php echo Url('home/users/regist'); ?>">免费注册</a>&nbsp;| </label>
				<label><a style="color:#666;line-height:32px;" target='_blank' href="<?php echo url('Users/forgetPass'); ?>">忘记密码? </a></label>
			</td>
		</tr>
		<tr>
