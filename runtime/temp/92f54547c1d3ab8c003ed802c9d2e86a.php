<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"C:\wamp64\www\project1/wstshop/home\view\default\user_login.html";i:1523179468;s:58:"C:\wamp64\www\project1/wstshop/home\view\default\base.html";i:1523179472;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\header.html";i:1523179466;s:64:"C:\wamp64\www\project1/wstshop/home\view\default\header_top.html";i:1523179466;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\footer.html";i:1523179472;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>用户登录-<?php echo WSTConf('CONF.shopName'); ?><?php echo WSTConf('CONF.seoShopTitle'); ?></title>
...
<div class="wst-clear"></div>
	...
	<div class="wst-login-head">
		<span class="pagel"><a href='<?php echo \think\Request::instance()->root(true); ?>'>&nbsp;首页</a></span> <span class="arrow">></span> <span class="pager">用户登录</span>
	</div>
	<div class="wst-login">
	<div class="wst-login_l">
		<img src="__STYLE__/img/img_login_left.png"/>
	</div>
	<div class="wst-login_r">
		<form method="post" autocomplete="off" data-validator-option='{theme:"yellow_right"}'>
		<span class="wst-login-u">欢迎登录<?php echo WSTConf('CONF.shopName'); ?></span>
		<table class="wst-table">
			...
			<tr class="wst-login-tr">
				<td colspan="2" style="padding-left:2px;position: relative;">
					<div class="wst-login-ch">
						<input id="rememberPwd" name="rememberPwd" class="ipt" checked="checked" type="checkbox" style="float:left;"/>
				     	<span>记住密码</span>
				    </div>                                  
			...
			<tr>
				<td colspan="2">
					<div style="width: 100%;height:36px;line-height:36px;float:left;"><a class="wst-login-but" href="javascript:void(0);" onclick='javascript:login()'>登录</a></div>
				</td>
			</tr>
			</table>
		</form>
