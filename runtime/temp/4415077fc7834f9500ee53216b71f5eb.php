<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"C:\wamp64\www\project1/wstshop/home\view\default\carts.html";i:1523179472;s:58:"C:\wamp64\www\project1/wstshop/home\view\default\base.html";i:1523179472;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\header.html";i:1523179466;s:64:"C:\wamp64\www\project1/wstshop/home\view\default\header_top.html";i:1523179466;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\footer.html";i:1523179472;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>我的购物车 - <?php echo WSTConf('CONF.shopName'); ?><?php echo WSTConf('CONF.seoShopTitle'); ?></title>
       ...
       <?php if(!empty($carts["carts"])): ?>
	       <div class='cart-item'>
	          <div class='goods-list'>
	             ...
	             <div class='item j-chk <?php if($vo2["isCheck"]==1): ?>selected<?php endif; ?> j-s1 j-g<?php echo $vo2["cartId"]; ?>'>
	                <div class='chk'><input id='gchk_<?php echo $vo2["cartId"]; ?>' type='checkbox' <?php if($vo2["isCheck"]==1): ?>checked<?php endif; ?> mval="<?php echo $vo2['shopPrice']; ?>" value="<?php echo $vo2['cartId']; ?>" sval="<?php echo $vo2['goodsStock']; ?>" allowbuy="<?php echo $vo2['allowBuy']; ?>" class='j-chk j-s1 j-gchk' onclick='checkChks(this,".j-g<?php echo $vo2["cartId"]; ?>")'></div>
			        <div class='goods'>
			            <div class='img'>
			            ...
			            <div class='name'>
				            ...
				            <div><span class="catName"><?php echo $specs['catName']; ?>：</span><?php echo $specs['itemName']; ?></div>
				            <?php endforeach; endif; else: echo "" ;endif; ?>
				            </div>
			            </div>
			            
			        </div>
			        <div class='price'><?php echo $vo2['shopPrice']; ?></div>
			        <div class='num'>
