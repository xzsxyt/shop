<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"C:\wamp64\www\project1/wstshop/home\view\default\brands_list.html";i:1523179472;s:58:"C:\wamp64\www\project1/wstshop/home\view\default\base.html";i:1523179472;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\header.html";i:1523179466;s:64:"C:\wamp64\www\project1/wstshop/home\view\default\header_top.html";i:1523179466;s:64:"C:\wamp64\www\project1/wstshop/home\view\default\right_cart.html";i:1523179466;s:60:"C:\wamp64\www\project1/wstshop/home\view\default\footer.html";i:1523179472;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>品牌街 - <?php echo WSTConf('CONF.shopName'); ?><?php echo WSTConf('CONF.seoShopTitle'); ?></title>
<meta name="auther" content="WSTShop,www.wstshop.net" />
<meta name="copyright" content="Copyright©2016-2066 Powered By WSTShop" />

<meta name="description" content="<?php echo WSTConf('CONF.seoShopDesc'); ?>,品牌街">
...
<div class="wst-container">
	<div class="wst-route"><a href="<?php echo url('home/index/index'); ?>" ><img style="float:left;margin-right:10px" src="__STYLE__/img/icon_dianpujie_09.png"/>首页</a> > <a href="<?php echo url('home/brands/index'); ?>">品牌街</a></div>
	...
	<ul class="wst-brands-list">
		<?php if(is_array($list['Rows']) || $list['Rows'] instanceof \think\Collection): $i = 0; $__LIST__ = $list['Rows'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<li class="wst-brands">
			<div class="wst-brand-img"><a target='_blank' href="<?php echo Url('home/goods/lists',['cat'=>$vo['catId'],'brand'=>$vo['brandId']]); ?>"><img class="goodsImg" data-original="__ROOT__/<?php echo $vo['brandImg']; ?>" title="<?php echo $vo['brandName']; ?>"/></a></div>
			<div class="wst-brand-name"><?php echo WSTMSubstr($vo['brandName'],0,15); ?></div>
			<div class='info'>
				<span><img src="__STYLE__/img/img_jrpp.png"/></span>
		        <p>欢迎进入<?php echo $vo['brandName']; ?></p>
		    </div>
		</li>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		<div class="wst-clear"></div>
