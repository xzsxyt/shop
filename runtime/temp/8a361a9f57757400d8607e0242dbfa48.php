<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"C:\wamp64\www\project1/wstshop/admin\view\messages\list.html";i:1523179456;s:51:"C:\wamp64\www\project1/wstshop/admin\view\base.html";i:1523179462;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
    ...
    <table class='wst-form wst-box-top'>
      ...
      <th width='150'>发送类型<font color='red'>*</font>：</th>
          <td style="text-align:left;">
            <label><input type="radio" name="sendType" id="sendType" value="users" class='ipt' onchange="sendToTheUser()" checked>全部会员</label>
